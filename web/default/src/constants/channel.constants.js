export const CHANNEL_OPTIONS = [
  ...
  { key: 46, text: 'Replicate', value: 46, color: 'blue' },
  {
    ...
    value: 8,
    color: 'pink',
    tip: '不推荐使用，请使用 <strong>自定义渠道 (Chat/Completions)</strong>渠道类型。注意，这里所需要填入的代理地址仅会在实际请求时替换域名部分，如果你想填入 OpenAI SDK 中所要求的 Base URL，请使用自定义渠道 (Chat/Completions) 渠道类型',
    description: '不推荐使用，请使用自定义渠道 (Chat/Completions) 渠道类型',
  },
  {
    key: 52,
    ...
    value: 52,
    color: 'pink',
    description: '自定义 OpenAI 兼容渠道，配置 Base URL 后直接访问 /chat/completions 等接口',
  },
